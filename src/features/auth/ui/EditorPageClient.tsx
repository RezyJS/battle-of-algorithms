    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col gap-6 xl:flex-row">
        <div className="flex-1">
          <div className="mb-4 rounded-xl border border-slate-200 bg-white/80 px-4 py-4 shadow-sm">
            ...
            <div className="space-y-3">
              {TIPS.map((tip) => (
                <div key={tip.title}>
                  ...
                  <pre className="text-xs rounded-md border border-indigo-100 bg-indigo-50/60 p-2 text-slate-800 font-mono overflow-x-auto">
                    {tip.code}
                  </pre>
                </div>
              ))}
