  ...
  return (
    <div className="bg-gray-900/50 rounded-xl border border-white/5 p-4 space-y-4">
      {canManageArena ? (
        ...
        <div className="space-y-1.5">
          <div className="text-xs text-gray-400">Режим</div>
          <div className="rounded-lg border border-white/10 bg-black/20 px-3 py-2 text-sm text-white">
      ...
      {canManageArena ? (
        ...
        <div className="space-y-2">
          ...
          >
            {isRunning ? (
              <>
                <Pause className="w-4 h-4" /> Пауза просмотра
              </>
            ) : (
              <>
                <Play className="w-4 h-4" /> Начать просмотр
              </>
            )}
          </button>
          <div className="rounded-lg border border-amber-800/40 bg-amber-950/30 px-3 py-2 text-xs text-amber-200">
